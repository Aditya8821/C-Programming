...
int main()
{
    SetConsoleTitle("@ Aditya Trivedi and COMPANY ---------> BANK MANAGEMENT SYSTEM");
    system("color 3f");
    Password();
    getch();
    return 0;
...
void mainmenu()
{
    ...
    t();
    system("color 5f");
    printf("\n\t\t\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2 WELCOME TO TRIVEDI'S BANK \xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2");
    printf("\n\n\t\t");
